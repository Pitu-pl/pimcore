...
```
#### Add database config file `/config/local/database.yml` BEFORE the update! 
...
#### Update your `public/index.php`
Update your `public/index.php` to the latest available version here: https://github.com/pimcore/skeleton/blob/master/public/index.php
