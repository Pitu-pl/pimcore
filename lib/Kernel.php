...
abstract class Kernel extends SymfonyKernel
{
    ...
    public function registerContainerConfiguration(LoaderInterface $loader)
    {
        ...
        $configRealPath = realpath($this->getRootDir() . '/config/' . $this->getEnvironment() . '/config.yml');
        if ($configRealPath === false) {
            throw new InvalidConfigurationException('File ' . $this->getRootDir() . '/config/ ' . $this->getEnvironment() . '/config.yml  cannot be found.');
        }
